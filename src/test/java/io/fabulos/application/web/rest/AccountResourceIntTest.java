...
import io.fabulos.application.FabulosSixApp;
import io.fabulos.application.domain.Authority;
import io.fabulos.application.domain.User;
import io.fabulos.application.repository.AuthorityRepository;
...
import io.fabulos.application.web.rest.errors.ExceptionTranslator;
import io.fabulos.application.web.rest.vm.KeyAndPasswordVM;
...
@SpringBootTest(classes = FabulosSixApp.class)
